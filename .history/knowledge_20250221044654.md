...
- Thư mục có file page.tsx ==> sign in có page.tsx. Sẽ tạo ra đường dẫn của web app "./signin"
  ...
  ++ Catch all sergment : signin/[...sign-in]/page.tsx: Ý là nó sẽ bắt đầu `http://localhost:3000/sign-in` nhưng được cái những param phía sau đều được chấp nhận hết /a/b/c sau thì nó vẫn sẽ chạy trang page.tsx
  ++ Optional catch all sergment: [[...sign-in]]
